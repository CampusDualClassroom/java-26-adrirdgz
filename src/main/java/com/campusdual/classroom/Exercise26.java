...
public class Exercise26 {
    public static void main(String[] args) {
        ...
        c1.callMyNumber();
        c1.callOtherNumber("652784654");
        c1.showContactDetails();

        c2.callMyNumber();
        c2.callOtherNumber("652784654");
        c2.showContactDetails();

        c3.callMyNumber();
        c3.callOtherNumber("652784654");
        c3.showContactDetails();

        c4.callMyNumber();
        c4.callOtherNumber("652784654");
        c4.showContactDetails();

        c5.callMyNumber();
        c5.callOtherNumber("652784654");
        c5.showContactDetails();

        c6.callMyNumber();
        c6.callOtherNumber("652784654");
